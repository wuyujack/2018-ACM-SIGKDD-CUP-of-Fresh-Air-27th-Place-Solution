# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 18:12:24 2018
...
delay = 3
location = 'LD'
f = open('/home/dedekinds/'+'LD_aqi_meo_4_22_test.csv')#BJ_aqi_meo_4_22_test.csv
...
print(pd_data)
pd_data.to_csv('result_'+location+'_Iteration_ans.csv')
