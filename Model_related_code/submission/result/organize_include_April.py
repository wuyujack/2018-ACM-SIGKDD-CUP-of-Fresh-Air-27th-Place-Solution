...
f = open('result_BJ_aqi48_ans_include_April.csv')
df =pd.read_csv(f)
model1 = df.values[:,1:]
...
model_name = 'result_aqi48_include_April.csv'
...
f = open('result_BJ_aqi48_75_ans_include_April.csv')
df =pd.read_csv(f)
model1 = df.values[:,1:]
f = open('result_LD_aqi48_ans.csv')
df =pd.read_csv(f)
...
pd_data.columns = ['test_id','PM2.5','PM10','O3']
model_dir = "last_submission"
model_name = 'result_aqi48_75_include_April.csv'
pd_data.to_csv(os.path.join(model_dir, model_name),index=False)
...
f = open('result_BJ_aqi48_ans_include_April(smape).csv')
df =pd.read_csv(f)
model1 = df.values[:,1:]
f = open('result_LD_aqi48_ans.csv')
df =pd.read_csv(f)
...
model_dir = "last_submission"
model_name = 'result_aqi48_include_April_smape.csv'
pd_data.to_csv(os.path.join(model_dir, model_name),index=False)
...
pd_data.columns = ['test_id','PM2.5','PM10','O3']
model_dir = "last_submission"
model_name = 'result_aqi48_75_include_April_v2.csv'
pd_data.to_csv(os.path.join(model_dir, model_name),index=False)
...
model_dir = "last_submission"
model_name = 'result_aqi48_include_April_smape_v2.csv'
pd_data.to_csv(os.path.join(model_dir, model_name),index=False)
...
f = open('result_BJ_aqi48_include_April_enhance2hour.csv')
df =pd.read_csv(f)
model1 = df.values[:,1:]
f = open('result_LD_aqi48_75_ans.csv')
df =pd.read_csv(f)
...
model_dir = "last_submission"
model_name = 'result_aqi48_include_April_smape_enhance.csv'
pd_data.to_csv(os.path.join(model_dir, model_name),index=False)
