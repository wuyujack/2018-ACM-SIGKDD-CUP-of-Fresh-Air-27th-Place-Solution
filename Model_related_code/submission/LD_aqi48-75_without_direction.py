...
num_of_variable =[80,97][location == 'BJ']#beiing
...
def recall_aqi(location,data,model_index):
    model_dir = "/home/dedekinds/A_meo_code/aqi48_75_without_direction"
...
print(pd_data)
model_dir = "result"
model_name = 'result_'+location+'_aqi48_75_without_direction_ans.csv'
