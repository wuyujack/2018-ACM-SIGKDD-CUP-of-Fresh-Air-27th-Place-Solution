...
def recall_aqi(location,data,model_index):
    ...
    model_name = '_lightgbm_'+location+str(model_index)+'_include_April(smape_weather).txt'
...
print(pd_data)
model_dir = "result"
model_name = 'result_'+location+'_aqi48_75_ans_include_April(smape_weather).csv'
