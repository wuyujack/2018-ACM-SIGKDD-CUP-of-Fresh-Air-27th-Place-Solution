# -*- coding: utf-8 -*-
"""
Created on Thu May 17 22:31:30 2018
...
kdd_data = pd.read_csv(r"F:\temp_LD_data_75_model_full_result_new_with_NO2.csv")
...
kdd_data.to_csv(r"F:\data_LD_sample_LSTM.csv",index = False,encoding = 'utf-8')#header=None, 
temp = kdd_data.head(100)
temp.to_csv(r"F:\temp_LD_LSTM_sample.csv",index = False, encoding = 'utf-8')