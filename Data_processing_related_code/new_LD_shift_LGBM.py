# -*- coding: utf-8 -*-
"""
Created on Fri May 18 09:43:09 2018
...
#kdd_data.to_csv(r"F:\data_LD_sample_LGBM.csv",index = False,  encoding = 'utf-8')
temp = kdd_data.head(100)
temp.to_csv(r"F:\temp_LD_LGBM_sample.csv",index = False, encoding = 'utf-8')